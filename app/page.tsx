      ...
      <header className="pt-8 pb-5 px-6 md:px-12 sticky top-0 bg-white/95 backdrop-blur-xl z-[60] border-b border-gray-100 shadow-sm transition-all duration-500">
        <div className="max-w-7xl mx-auto flex justify-between items-center mb-6">
          ...
          <div className="flex-1 flex justify-center">
            <Link href="/" className="group flex items-center justify-center transition-opacity hover:opacity-90 relative w-[280px] h-[100px]">
              {/* Opacity %15 to not interrupt readability, absolute centered */}
              <svg viewBox="0 0 100 85" className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[52%] w-28 h-28 text-[#D4AF37] opacity-[0.15] drop-shadow-sm group-hover:scale-105 transition-transform duration-700 z-0" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="miter">
              ...
              <div className="relative z-10 flex flex-col items-center leading-tight">
                <span className="text-2xl md:text-3xl font-serif tracking-[0.3em] font-black bg-clip-text text-transparent bg-dark-gradient uppercase">
                  Zeray
                </span>
                <span className="text-2xl md:text-3xl font-serif tracking-[0.3em] font-black bg-clip-text text-transparent bg-dark-gradient uppercase">
                  Gold
              ...
              (selectedCategory === 'Hepsi'
                ...
                >
                  ...
                  <div className="text-center flex-1 flex flex-col justify-between px-1">
                    ...
                    <a
                      href={`https://wa.me/905537467870?text=${encodeURIComponent(`Merhaba, ${product.name} hakkında bilgi almak istiyorum.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full bg-[#25D366] text-white py-2.5 text-[10px] font-bold tracking-[0.15em] uppercase hover:bg-[#20bd5a] transition-all duration-300 mb-3 flex items-center justify-center gap-2 relative z-10 rounded-sm"
                    >
                      <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
