  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="py-5 px-8 md:px-16 border-b border-zinc-100 flex justify-between items-center bg-white sticky top-0 z-50 shadow-sm">
        ...
        <Link href="/" className="group inline-flex flex-col items-center transition-opacity hover:opacity-90 relative scale-75 md:scale-90 flex items-center justify-center">
